...
Ornn provides three **core skills** that teach AI agents how to interact with the platform. They live in the [`.ornn-skills/`](https://github.com/aevatarAI/chrono-ornn/tree/main/.ornn-skills) directory of the chrono-ornn repository.
...
```
Fetch the three Ornn core skill files from https://github.com/aevatarAI/chrono-ornn/tree/main/.ornn-skills — each directory (ornn-search-and-run, ornn-upload, ornn-build) contains a SKILL.md file. Download each SKILL.md and save them into my project's codex/skills/ directory. The final structure should be:
