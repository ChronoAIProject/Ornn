      ...
      post: {
        ...
        responses: {
          ...
          ...problemResponses(
            ...
            401,
            { 403: "Forbidden — the token lacks create/publish, or requests public creation without ornn:skill:publish." },
      ...
      put: {
        ...
        responses: {
          ...
          ...problemResponses(
            ...
            401,
            {
              403: "Forbidden — the token lacks update/publish, or a publish-only caller supplies isPrivate, or the caller has no WRITE tier on this skill; or the caller is a `write` grantee attempting to CHANGE `isPrivate`, which is ADMIN-tier.",
            },
