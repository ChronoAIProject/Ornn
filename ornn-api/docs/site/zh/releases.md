...
1. **Ornn 核心技能** — 三个技能位于 `.ornn-apis/` 目录：
...
| 范围 | 变更 |
|------|------|
| `.ornn-apis/` | 新增目录，包含三个核心技能 |
| `.ornn-apis/setup.sh` | 已移除 — 由提示词安装替代 |
| `.ornn-apis/ornn-upload/SKILL.md` | 修复 ZIP 打包说明（需要根文件夹）并添加 base64 body 编码指南 |
...
| `ornn-api/package.json` | 版本号 0.1.2 → 0.1.3 |
| `ornn-web/package.json` | 版本号 0.1.2 → 0.1.3 |
