...
export function ServiceDetailPage() {
  ...
  if (isLoading) {
    return (
      <PageTransition>
        <div className="py-4">
          <p className="font-text text-sm text-meta">Loading...</p>
        </div>
      </PageTransition>
    );
  }
    ...
    <PageTransition>
      <div className="py-4">
        <button
          ...
          className="flex items-center gap-2 font-text text-sm text-meta hover:text-accent transition-colors mb-4 cursor-pointer"
        >
        ...
        <div className="mb-6">
          ...
          {service.description && (
            <p className="font-text text-sm text-meta">{service.description}</p>
          )}
        </div>
