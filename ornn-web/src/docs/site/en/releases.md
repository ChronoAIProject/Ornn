...
1. **Ornn Core Skills** — Three skills shipped in the `.ornn-apis/` directory:
...
| Area | Change |
|------|--------|
| `.ornn-apis/` | New directory with three core skills |
| `.ornn-apis/setup.sh` | Removed — replaced by prompt-based installation |
| `.ornn-apis/ornn-upload/SKILL.md` | Fixed ZIP packaging instructions (root folder required) and added base64 body encoding guide |
...
| `ornn-api/package.json` | Version bump 0.1.2 → 0.1.3 |
| `ornn-web/package.json` | Version bump 0.1.2 → 0.1.3 |
